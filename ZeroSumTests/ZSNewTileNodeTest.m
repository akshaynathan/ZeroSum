...
- (void)testInit {
  ...
  XCTAssert(t.value == 4, "nodeWithValue should set new tile node value.");
...
- (void)testToRealTile {
  ...
  XCTAssert(k.row == 1, "toRealTile should set row to 1.");
  XCTAssert(t.isEmerging == YES, "toRealTile should set isEmerging to YES.");
}
